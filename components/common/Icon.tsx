...
const icons = {
  ...
  insights: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h-1.5m1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 1.5m-2-1.5V3"
    />
  ),
  creative: (
    <path
...
const Icon: React.FC<IconProps> = ({ icon, className = 'h-6 w-6' }) => {
  return (
    <svg
